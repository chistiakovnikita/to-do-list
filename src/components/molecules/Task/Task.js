                    ...
                    : `
                        <div>
                            <input
                                ...
                                type="checkbox" ${JSON.parse(this.props.iscompleted) ? 'cheked' : ""}
                                id="${this.props.id}"
                            >
                        ...
                        <div class='d-flex'>
                            <button
                                ...
                                class="btn btn-danger btn-sm m-2 delete-action"
                            >Delete</button>
                            <button
                                data-id="${this.props.id}"
                                class="btn btn-outline-primary btn-sm m-2 edit-action"
                            >Edit</button>
                        </div>
                    `
                    }
